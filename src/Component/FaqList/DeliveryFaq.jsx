...
const FAQS = [
  {
    topic: "딜리버리",
    questions: [
      "[코키티 딜리버리] 코키티 매장과 동일한 메뉴를 판매하나요?",
      "[코키티 딜리버리] 서비스 이용 가능한 지역은 어디인가요?",
      "[코키티 딜리버리] 이용가능한 결제수단은 어떻게 되나요?",
      "[코키티 딜리버리] 배달 최소금액과 배달비는 어떻게 되나요?",
      "[코키티 딜리버리] 배달 주소지를 잘못 입력했어요.",
    ]
  }
];
